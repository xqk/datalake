package io.datalake.commons.wrapper;


import com.google.gson.Gson;
import io.datalake.commons.holder.ThreadLocalContextHolder;
...
public class XssAndSqlHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    public static boolean checkSqlInjection(Object obj){
        ...
        String whiteLists = CommonBeanFactory.getBean(Environment.class).getProperty("datalake.sqlinjection.whitelists", String.class, null);
