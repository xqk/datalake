package io.datalake.auth.filter;

import com.auth0.jwt.algorithms.Algorithm;
import io.datalake.auth.entity.ASKToken;
import io.datalake.auth.entity.JWTToken;
import io.datalake.auth.entity.SysUserEntity;
import io.datalake.auth.entity.TokenInfo;
import io.datalake.auth.handler.ApiKeyHandler;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
    ...
    private String refreshToken(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (user == null) {
            DataLakeException.throwException(Translator.get("i18n_not_find_user"));
        }
