...
import io.datalake.auth.api.AuthApi;
    ...
    public Object login(@RequestBody LoginDto loginDto) throws Exception {
        ...
        if (loginType == 1 && isSupportLdap) {
            ...
            if (!validateResult.isSuccess()) {
                DataLakeException.throwException(validateResult.getMsg());
            }
        ...
        if (ObjectUtils.isEmpty(user)) {
            DataLakeException.throwException(Translator.get("i18n_id_or_pwd_error"));
        }
