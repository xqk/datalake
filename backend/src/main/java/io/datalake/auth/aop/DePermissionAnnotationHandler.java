...
import io.datalake.auth.util.ReflectUtil;
...
public class DePermissionAnnotationHandler {
    ...
    @Around(value = "@annotation(io.datalake.auth.annotation.DePermissions)")
    ...
    @Around(value = "@annotation(io.datalake.auth.annotation.DePermission)")
