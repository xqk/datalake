...
import io.datalake.map.dto.entity.*;
import io.datalake.map.dto.entity.Properties;
import io.datalake.map.dto.response.MapResponse;
import io.datalake.map.dto.response.MapResultDto;
...
import io.datalake.plugins.common.base.mapper.AreaMappingMapper;
...
public class MapUtils {
    ...
    private static final String path = "/opt/datalake/data/行政区划列表2020-03.xlsx";
    private static final String featureDir = "/opt/datalake/data/feature/";
