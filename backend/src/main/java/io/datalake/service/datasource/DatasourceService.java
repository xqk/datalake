package io.datalake.service.datasource;
...
import io.datalake.commons.constants.SysAuthConstants;
...
import io.datalake.commons.utils.CommonThreadPool;
import io.datalake.commons.utils.LogUtil;
import io.datalake.controller.ResultHolder;
import io.datalake.controller.datasource.request.UpdataDsRequest;
...
import io.datalake.ext.ExtDataSourceMapper;
...
import io.datalake.plugins.common.base.mapper.DatasourceMapper;
...
import io.datalake.provider.datasource.ApiProvider;
...
public class DatasourceService {
    ...
    public Collection<DataSourceType> types() {
        ...
        SpringContextUtil.getApplicationContext().getBeansOfType(io.datalake.plugins.datasource.service.DatasourceService.class).values().forEach(datasourceService -> {
