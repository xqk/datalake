...
import io.datalake.controller.request.panel.PanelSubjectRequest;
...
import io.datalake.plugins.common.base.mapper.PanelSubjectMapper;
    ...
    public synchronized void update(PanelSubject request) {
        if (StringUtils.isEmpty(request.getId())) {
            ...
            if (CollectionUtils.isEmpty(subjectAll)) {
                ...
                DataLakeException.throwException("名称已经存在");
            }
        }
    }
