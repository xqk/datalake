package io.datalake.service.engine;
...
import io.datalake.dto.datasource.MysqlConfiguration;
...
import io.datalake.plugins.common.base.mapper.DeEngineMapper;
...
public class EngineService {
    ...
    public Datasource getDeEngine() throws Exception {
        ...
        if (isLocalMode()) {
            ...
            jsonObjectMap.put("password", env.getProperty("doris.password", "datalake"));
