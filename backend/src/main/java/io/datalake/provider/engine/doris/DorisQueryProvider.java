package io.datalake.provider.engine.doris;
...
import io.datalake.plugins.common.base.mapper.DatasetTableFieldMapper;
import io.datalake.plugins.common.constants.DorisConstants;
...
import io.datalake.provider.Utils;
...
import static io.datalake.plugins.common.constants.SQLConstants.TABLE_ALIAS_PREFIX;
...
public class DorisQueryProvider extends QueryProvider {
        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            for (int i = 0; i < fields.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(f.getExtField()) && f.getExtField() == 2) {
                    ...
                    originField = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getDatalakeName());
                } else {
                    originField = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getDatalakeName());
                }
        ...
        if (CollectionUtils.isNotEmpty(xAxis)) {
            for (int i = 0; i < xAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(x.getExtField()) && x.getExtField() == 2) {
                    ...
                    originField = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getDatalakeName());
                } else {
                    originField = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getDatalakeName());
                }
                String fieldAlias = String.format(SQLConstants.FIELD_ALIAS_X_PREFIX, i);
        ...
        if (CollectionUtils.isNotEmpty(yAxis)) {
            for (int i = 0; i < yAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(y.getExtField()) && y.getExtField() == 2) {
                    ...
                    originField = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), y.getDatalakeName());
                } else {
                    originField = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), y.getDatalakeName());
                }
            ...
            for (int i = 0; i < xAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(x.getExtField()) && x.getExtField() == 2) {
                    ...
                    if (x.getDeType() == 2 || x.getDeType() == 3) {
                        originField = String.format(DorisConstants.CAST, String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getDatalakeName()), DorisConstants.DEFAULT_FLOAT_FORMAT);
                    } else {
                        originField = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getDatalakeName());
                    }
                }
    ...
    public String createRawQuerySQL(String table, List<DatasetTableField> fields, Datasource ds) {
        String[] array = fields.stream().map(f -> {
            ...
            stringBuilder.append("`").append(f.getDatalakeName()).append("` AS ").append(f.getDatalakeName());
    ...
    public String transCustomFilterList(SQLObj tableObj, List<ChartFieldCustomFilterDTO> requestList) {
        ...
        for (ChartFieldCustomFilterDTO request : requestList) {
            ...
            if (ObjectUtils.isNotEmpty(field.getExtField()) && field.getExtField() == 2) {
                ...
                originName = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getDatalakeName());
            } else {
                originName = String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getDatalakeName());
            }
        ...
        if (CollectionUtils.isNotEmpty(x.getFilter()) && x.getFilter().size() > 0) {
            x.getFilter().forEach(f -> {
                ...
                if (StringUtils.equalsIgnoreCase(f.getTerm(), "null")) {
                    ...
                    whereValue = String.format(DorisConstants.WHERE_VALUE_VALUE, f.getValue());
                }
                list.add(SQLObj.builder()
                        .whereField(whereName)
    ...
    private SQLObj getYFields(ChartViewFieldDTO y, String originField, String fieldAlias) {
        String fieldName = "";
        if (StringUtils.equalsIgnoreCase(y.getDatalakeName(), "*")) {
    ...
    private String calcFieldRegex(String originField, SQLObj tableObj) {
        ...
        for (DatasetTableField ele : calcFields) {
            originField = originField.replaceAll("\\[" + ele.getId() + "]",
                    String.format(DorisConstants.KEYWORD_FIX, tableObj.getTableAlias(), ele.getDatalakeName()));
        }
        return originField;
    }
