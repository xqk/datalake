package io.datalake.provider.engine.mysql;
...
import io.datalake.plugins.common.constants.engine.MysqlConstants;
        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            for (int i = 0; i < fields.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(f.getExtField()) && f.getExtField() == 2) {
                    ...
                    originField = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getDatalakeName());
                } else {
                    originField = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getDatalakeName());
                }
        ...
        if (CollectionUtils.isNotEmpty(xAxis)) {
            for (int i = 0; i < xAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(x.getExtField()) && x.getExtField() == 2) {
                    ...
                    originField = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getDatalakeName());
                } else {
                    originField = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getDatalakeName());
                }
                String fieldAlias = String.format(SQLConstants.FIELD_ALIAS_X_PREFIX, i);
        ...
        if (CollectionUtils.isNotEmpty(yAxis)) {
            for (int i = 0; i < yAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(y.getExtField()) && y.getExtField() == 2) {
                    ...
                    originField = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), y.getDatalakeName());
                } else {
                    originField = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), y.getDatalakeName());
                }
            ...
            for (int i = 0; i < xAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(x.getExtField()) && x.getExtField() == 2) {
                    ...
                    if (x.getDeType() == 2 || x.getDeType() == 3) {
                        originField = String.format(MysqlConstants.CAST, String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getDatalakeName()), MysqlConstants.DEFAULT_FLOAT_FORMAT);
                    } else {
                        originField = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getDatalakeName());
                    }
                }
    ...
    public String transCustomFilterList(SQLObj tableObj, List<ChartFieldCustomFilterDTO> requestList) {
        ...
        for (ChartFieldCustomFilterDTO request : requestList) {
            ...
            if (ObjectUtils.isNotEmpty(field.getExtField()) && field.getExtField() == 2) {
                ...
                originName = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getDatalakeName());
            } else {
                originName = String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getDatalakeName());
            }
    ...
    private String calcFieldRegex(String originField, SQLObj tableObj) {
        ...
        for (DatasetTableField ele : calcFields) {
            originField = originField.replaceAll("\\[" + ele.getId() + "]",
                    String.format(MysqlConstants.KEYWORD_FIX, tableObj.getTableAlias(), ele.getDatalakeName()));
        }
        return originField;
    }
