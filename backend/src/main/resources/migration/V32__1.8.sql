...
INSERT INTO `my_plugin` VALUES (2, '视图默认插件', 'default', 0, 20000, 'view', '默认视图插件', '1.0-SNAPSHOT', NULL, 'fit2cloud-chenyw', 0, NULL, NULL, 'datalake-extensions-backend', NULL);
...
DROP TABLE IF EXISTS `datalake_code_version`;
CREATE TABLE `datalake_code_version` (
  `installed_rank` int(11) NOT NULL,
  `description` varchar(255) DEFAULT NULL,
  `installed_on` timestamp NULL DEFAULT NULL,
  `success` tinyint(1) NOT NULL,
  PRIMARY KEY (`installed_rank`),
  KEY `datalake_version_s_idx` (`success`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of datalake_code_version
-- ----------------------------
BEGIN;
INSERT INTO `datalake_code_version` VALUES (0, 'init', NULL, 1);
COMMIT;
