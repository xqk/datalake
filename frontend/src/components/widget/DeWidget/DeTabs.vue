<template>
  <div class="de-tabs-div">
    ...
    >
      <!--  <plugin-com ref="datalake-tabs" v-model="activeTabName" type="card" class="de-tabs" component-name="datalake-tabs" @tab-click="handleClick"> -->
...
export default {
  ...
  data() {
    return {
      ...
      url: '/api/pluginCommon/component/datalake-tabs'
      /* fontColor: '#999999',
        activeColor: '#f18406',
