        ...
        <el-col :span="12">
          <el-form ref="loginForm" :model="loginForm" :rules="loginRules" size="default">
            <div class="login-logo">
              <svg-icon v-if="!loginLogoUrl && axiosFinished" icon-class="DataLake" custom-class="login-logo-icon" />
            ...
            <div v-else class="login-welcome">
              {{ $t('login.welcome') + (uiInfo && uiInfo['ui.title'] && uiInfo['ui.title'].paramValue || ' DataLake') }}
            </div>
