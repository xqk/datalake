export default {
  ...
  dataset: {
    ...
    parse_error: 'Excel解析失败，请检查格式、字段等信息。具体参考：https://datalake.io/docs/faq/dataset_faq/',
  ...
  datasource: {
    auth_method: '认证方式',
    passwd: '用户名密码',
    kerbers_info: '请确保 krb5.Conf、Keytab Key，已经添加到路径：/opt/datalake/conf',
  ...
  wizard: {
    ...
    contact_us: '联系我们',
    demo_video_hint: '如何3分钟制作一个DataLake 数据看板、并分享给他人',
    online_document_hint: '涵盖DataLake的安装步骤、用户手册、使用教程、常见问题的解决方案、以及二次开发等',
    teaching_video_bottom_hint: '更多视频资料',
    enterprise_edition_hint1: '提供企业级应用场景 X-Pack 增强包',
    enterprise_edition_hint2: '提供高等级原厂服务支持',
    enterprise_edition_hint3: '提供 DataLake 最佳实践建议',
