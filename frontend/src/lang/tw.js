export default {
  ...
  dataset: {
    ...
    parse_error: 'Excel解析失敗，請檢查格式、字段等信息。具體參考：https://datalake.io/docs/faq/dataset_faq/',
  ...
  datasource: {
    auth_method: '認證方式',
    passwd: '用戶名密碼',
    kerbers_info: '請確保 krb5.Conf、Keytab Key，已經添加到路徑：/opt/datalake/conf',
  ...
  wizard: {
    ...
    contact_us: '聯繫我們',
    demo_video_hint: '如何3分鐘製作一個DataLake 數據看闆、並分享給他人',
    online_document_hint: '涵蓋DataLake的安裝步驟、用戶手冊、使用教程、常見問題的解決方案、以及二次開發等',
    teaching_video_bottom_hint: '更多視頻資料',
    enterprise_edition_hint1: '提供企業級應用場景 X-Pack 增強包',
    enterprise_edition_hint2: '提供高等級原廠服務支持',
    enterprise_edition_hint3: '提供 DataLake 最佳實踐建議',
