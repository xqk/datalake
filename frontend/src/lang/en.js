export default {
  ...
  dataset: {
    ...
    parse_error: 'Parse failed,please check.Reference：https://datalake.io/docs/faq/dataset_faq/',
  ...
  datasource: {
    ...
    kerbers_info: 'Please make sure krb5 Conf, KeyTab key, added to path: /opt/datalake/conf',
  ...
  wizard: {
    welcome_title: 'Welcome To Use DataLake',
    ...
    demo_video_hint: 'How to make a DataLake dashboard in 3 minutes and share it with others',
    online_document_hint: 'It covers the installation steps, user manuals, tutorials, solutions to common problems, and secondary development of DataLake',
